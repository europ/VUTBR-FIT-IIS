                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('pobocky.update', ['id' => $pobocka->id_pobocky]) }}">
                        ...
                        <div class="form-group{{ $errors->has('adresa_ulice') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="adresa_ulice" type="text" class="form-control" name="adresa_ulice" value="{{ old('adresa_ulice', $pobocka->adresa_ulice) }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('adresa_cislo') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="adresa_cislo" type="text" class="form-control" name="adresa_cislo" value="{{ old('adresa_cislo', $pobocka->adresa_cislo) }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('adresa_mesto') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="adresa_mesto" type="text" class="form-control" name="adresa_mesto" value="{{ old('adresa_mesto', $pobocka->adresa_mesto) }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('adresa_psc') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="adresa_psc" type="text" class="form-control" name="adresa_psc" value="{{ old('adresa_psc', $pobocka->adresa_psc) }}" required autofocus>
